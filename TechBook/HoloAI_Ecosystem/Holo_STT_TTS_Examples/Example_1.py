...
class HoloVoice:
    ...
    def __init__(self, commands=None):
        ...
        self.soundChoice     = 1  
        self.timeOut         = 10  
        self.standardMaleVoice   = None
        self.standardFemaleVoice = None
        self.advancedMaleVoice   = None
        self.advancedFemaleVoice = None
        self.sounds          = {}
        self.synthesisMode   = 'Standard'
        ...
        self.holoTTS  = HoloTTS(self)
        self.holoSTT  = HoloSTT(self)
        self.holoWave = HoloWave(self)
